...
public class Mynotice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Mynotice.this,"Please enter filename before uploading",Toast.LENGTH_SHORT).show();

        //attaching listeners to views
/*        findViewById(R.id.buttonUploadFile).setOnClickListener(this);
        findViewById(R.id.textViewUploads).setOnClickListener(this);*/
        tb=(TextView)findViewById(R.id.textViewUploads);
        tb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Mynotice.this, ViewUploadsActivity.class));
            }
        });
        bb=(Button)findViewById(R.id.buttonUploadFile);
